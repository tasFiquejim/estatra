<aside :class="sidebarToggle ? 'translate-x-0 lg:w-[90px]' : '-translate-x-full'"
    ...
    <a href="{{ route('property.index') }}"
       ...
       class="menu-item group"
       :class="{
           'menu-item-active': selected === 'Calendar' && page === 'calendar',
           'menu-item-inactive': !(selected === 'Calendar' && page === 'calendar')
       }">
       
        <svg 
            class="transition-colors"
            :class="{
                'menu-item-icon-active': selected === 'Calendar' && page === 'calendar',
                'menu-item-icon-inactive': !(selected === 'Calendar' && page === 'calendar')
            }"
            width="24" height="24" viewBox="0 0 24 24" fill="none"
            xmlns="http://www.w3.org/2000/svg">
