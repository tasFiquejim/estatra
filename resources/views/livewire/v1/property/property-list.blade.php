                        ...
                        @forelse ($this->properties as $property)
                            <tr class="hover:bg-gray-50 dark:hover:bg-gray-900/50">
                                ...
                                <td class="px-6 py-4 text-sm text-gray-500 whitespace-nowrap dark:text-gray-400">
                                    {{ $property->address }}
                                    @if ($property->city)
                                        <br><span class="text-xs">{{ $property->city }}@if ($property->state)
                                                , {{ $property->state }}
                                            @endif
                                        </span>
                                    @endif
                                ...
                                <td class="px-6 py-4 text-sm text-gray-500 whitespace-nowrap dark:text-gray-400">
                                    ...
                                    <br><span
                                        class="text-xs text-gray-400">{{ $property->created_at->format('g:i A') }}</span>
                                </td>
                                <td
                                ...
                                <tr>
                                    <td colspan="6" class="px-6 py-12 text-center">
                                        <div class="flex flex-col items-center">
                                            ...
                                            <p class="mt-2 text-sm text-gray-500 dark:text-gray-400">No properties found.
                                            </p>
                                            <p class="mt-1 text-xs text-gray-400">Create your first property to get
                                                started.</p>
                                        </div>
                                    </td>
                                </tr>
