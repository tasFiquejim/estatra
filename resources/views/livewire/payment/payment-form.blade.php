<div class="max-w-4xl p-2 mx-auto">
    ...
    <div class="mb-6">
        <nav class="flex mb-2" aria-label="Breadcrumb">
            <ol class="inline-flex items-center space-x-1 text-sm text-gray-500">
                <li><a href="{{ route('payment.index') }}" class="hover:text-gray-700">Payments</a></li>
                <li class="flex items-center">
                    ...
                    <span class="text-gray-700">{{ $isEdit ? 'Edit Payment' : 'Record Payment' }}</span>
                </li>
            </ol>
        </nav>
    ...
    <form wire:submit="save" class="p-6 bg-white rounded-lg shadow dark:bg-gray-800">
        ...
        <!-- Lease Selection -->
        <div class="mb-8">
            <h3 class="mb-4 text-lg font-medium text-gray-900 dark:text-white">Lease Information</h3>
            ...
            <div class="grid grid-cols-1 gap-6">
                ...
                @if ($this->selectedLease)
                    <div class="p-4 rounded-lg bg-gray-50 dark:bg-gray-700">
                        <h4 class="mb-2 text-sm font-medium text-gray-700 dark:text-gray-300">Lease Details</h4>
        ...
        <!-- Payment Details -->
        <div class="mb-8">
            <h3 class="mb-4 text-lg font-medium text-gray-900 dark:text-white">Payment Details</h3>
            ...
            <div class="grid grid-cols-1 gap-6 md:grid-cols-2">
                ...
                <div>
                    ...
                    @error('rent_period')
                        <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                    @enderror
                    <p class="mt-1 text-xs text-gray-500 dark:text-gray-400">Select the month for which rent is being
                        paid</p>
                </div>
                ...
                <!-- Receipt Number -->
                {{-- <div>
                    <label for="receipt_number" class="block mb-2 text-sm font-medium text-gray-700 dark:text-gray-300">
                        Receipt Number
                    </label>
