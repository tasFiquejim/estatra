<div class="max-w-4xl p-2 mx-auto">
    ...
    <div class="mb-6">
        <nav class="flex mb-2" aria-label="Breadcrumb">
            <ol class="inline-flex items-center space-x-1 text-sm text-gray-500">
                <li><a href="{{ route('lease.index') }}" class="hover:text-gray-700">Leases</a></li>
                <li class="flex items-center">
                    ...
                    <span class="text-gray-700">{{ $isEdit ? 'Edit Lease' : 'Create Lease' }}</span>
                </li>
            </ol>
        </nav>
    ...
    <form wire:submit="save" class="p-6 bg-white rounded-lg shadow dark:bg-gray-800">
        ...
        <div class="mb-8">
            <h3 class="mb-4 text-lg font-medium text-gray-900 dark:text-white">Lease Parties</h3>
            ...
            <div class="grid grid-cols-1 gap-6 md:grid-cols-2">
                ...
                <div>
                    ...
                    <select wire:model="unit_id" id="unit_id"
                        ...
                        @foreach ($this->availableUnits as $propertyName => $units)
                ...
                <!-- Tenant Selection -->
                <div>
                    <label for="tenant_id" class="block mb-2 text-sm font-medium text-gray-700 dark:text-gray-300">
        ...
        <div class="mb-8">
            ...
            <div class="grid grid-cols-1 gap-6 md:grid-cols-2">
                ...
                <!-- End Date -->
                <div>
                    <label for="end_date" class="block mb-2 text-sm font-medium text-gray-700 dark:text-gray-300">
                        Lease End Date
                    </label>
                    ...
                    @error('end_date')
                        <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                    @enderror
                    <p class="mt-1 text-xs text-gray-500 dark:text-gray-400">Leave blank for month-to-month lease</p>
                </div>
        ...
        <!-- Financial Terms -->
        <div class="mb-8">
            <h3 class="mb-4 text-lg font-medium text-gray-900 dark:text-white">Financial Terms</h3>
            ...
            <div class="grid grid-cols-1 gap-6 md:grid-cols-3">
                ...
                <div>
                    ...
                    <input type="number" wire:model="rent_amount" id="rent_amount" step="0.01" placeholder="0.00"
                        class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:text-white" />
                    @error('rent_amount')
                        <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                    @enderror
            ...
            @if ($rent_amount || $service_charge)
                <div class="p-4 mt-4 rounded-lg bg-gray-50 dark:bg-gray-700">
                    <h4 class="text-sm font-medium text-gray-700 dark:text-gray-300">Monthly Total</h4>
